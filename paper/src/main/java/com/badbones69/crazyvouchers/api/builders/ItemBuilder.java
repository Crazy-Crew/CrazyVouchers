...
public class ItemBuilder extends AbstractItemHandler {
    ...
    public ItemBuilder(ItemBuilder itemBuilder) {
        ...
        this.voucherName = itemBuilder.voucherName;
    }

    /**
     * Adds the voucher to the item meta pdc.
     *
     * @param voucherName the name of the voucher.
     * @return the ItemBuilder with updated information.
     */
    public ItemBuilder setVoucherName(String voucherName) {
        setString(PersistentKeys.voucher_item.getNamespacedKey(), this.voucherName = voucherName);

        return this;
    }

    /**
     * @return the name of the voucher.
     */
    public String getVoucherName() {
        return getString(PersistentKeys.voucher_item.getNamespacedKey());
    }
    ...
    public static ItemBuilder convertString(String itemString, String placeHolder) {
        ...
        try {
            ...
            CrazyVouchers plugin = JavaPlugin.getPlugin(CrazyVouchers.class);
    ...
    /**
     * @return a plain text version of the display name.
     */
